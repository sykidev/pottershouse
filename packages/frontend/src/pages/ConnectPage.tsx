...
import { Book, Music, Baby, Users, Heart, HandHeart, Phone, Mail, MapPin, Sparkles } from 'lucide-react';
...
const ministries = [
  {
    icon: Book,
    title: 'Bible Study',
    description: 'Wednesday evenings at 7:00 PM. Deepen your understanding of Scripture in community.',
    color: 'from-blue-600 to-blue-800',
    bgColor: 'bg-blue-600/10',
    hoverColor: 'hover:border-blue-600/30',
  },
  {
    icon: Music,
    title: 'Worship Team',
    description: 'Join our team of musicians and singers who lead the congregation in praise each week.',
    color: 'from-purple-600 to-purple-800',
    bgColor: 'bg-purple-600/10',
    hoverColor: 'hover:border-purple-600/30',
  },
  {
    icon: Baby,
    title: "Children's Ministry",
    description: 'Nurturing the faith of our youngest members every Sunday during the main service.',
    color: 'from-pink-600 to-pink-800',
    bgColor: 'bg-pink-600/10',
    hoverColor: 'hover:border-pink-600/30',
  },
  {
    icon: Users,
    title: 'Youth Group',
    description: 'A vibrant community for teenagers to grow in faith, friendship, and purpose.',
    color: 'from-amber to-amber-700',
    bgColor: 'bg-amber/10',
    hoverColor: 'hover:border-amber/30',
  },
  {
    icon: HandHeart,
    title: 'Community Outreach',
    description: 'Serving our neighbors through food drives, community events, and local partnerships.',
    color: 'from-green-600 to-green-800',
    bgColor: 'bg-green-600/10',
    hoverColor: 'hover:border-green-600/30',
  },
  {
    icon: Heart,
    title: 'Prayer Team',
    description: 'Interceding daily for the church, community, and world. All are welcome to join.',
    color: 'from-crimson to-crimson-800',
    bgColor: 'bg-crimson/10',
    hoverColor: 'hover:border-crimson/30',
  },
];
    ...
    <div>
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-blue-900 via-crimson to-purple-900">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-6xl font-serif font-bold mb-4 text-white drop-shadow-2xl">Get Connected</h1>
      ...
      <section className="bg-gradient-to-b from-warm-white to-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-serif font-bold text-gray-900 mb-3">Ministries & Groups</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">Find a community where you can serve, grow, and belong</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {ministries.map((ministry, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`group relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border-2 border-transparent ${ministry.hoverColor} overflow-hidden`}
                >
                  {/* Gradient background on hover */}
                  <div className={`absolute inset-0 ${ministry.bgColor} opacity-0 group-hover:opacity-100 transition-opacity duration-500`} />

                  {/* Content */}
                  <div className="relative z-10">
                    <div className={`w-16 h-16 bg-gradient-to-br ${ministry.color} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500 shadow-lg`}>
      ...
      <section className="bg-gradient-to-b from-white to-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-serif font-bold text-gray-900 mb-3">Meet Our Team</h2>
            <p className="text-gray-600">Connect with our dedicated servant leaders</p>
          </div>
      ...
      <section className="relative py-16 overflow-hidden bg-gradient-to-br from-crimson via-crimson-800 to-purple-900">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-8 text-white drop-shadow-2xl">Ready to take a next step?</h2>
